...
namespace theme_cr_organizacional\api;
...
class accessibility extends external_api {
    ...
    public static function savethemesettings($formdata) {
        ...
        if ($data['fonttype'] && in_array($data['fonttype'], ['default', 'odafont'])) {
            ...
            set_user_preference('themecr_organizacionalsettings_fonttype', $fonttype);
        }
        ...
        set_user_preference('themecr_organizacionalsettings_enableaccessibilitytoolbar', $enableaccessibilitytoolbar);

        \core\notification::success(get_string('themesettingg:successfullysaved', 'theme_cr_organizacional'));
    ...
    public static function getthemesettings() {
        return [
            'fonttype' => get_user_preferences('themecr_organizacionalsettings_fonttype', 'default'),
            'enableaccessibilitytoolbar' => get_user_preferences('themecr_organizacionalsettings_enableaccessibilitytoolbar', false)
        ];
    }
