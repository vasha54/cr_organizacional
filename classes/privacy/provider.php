...
namespace theme_cr_organizacional\privacy;
...
class provider implements
    ...
    const FONTTYPE = 'themecr_organizacionalsettings_fonttype';
    /** The user preference for the enable accessibility toolbar. */
    const TOOLBAR = 'themecr_organizacionalsettings_enableaccessibilitytoolbar';
    ...
    public static function get_metadata(collection $items) : collection {
        ...
        $items->add_user_preference(self::FONTTYPE, 'privacy:metadata:preference:themecr_organizacionalsettings_fonttype');
        $items->add_user_preference(self::TOOLBAR, 'privacy:metadata:preference:themecr_organizacionalsettings_enableaccessibilitytoolbar');
        return $items;
    }
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($toolbar)) {
            writer::export_user_preference(
                'theme_cr_organizacional',
                self::TOOLBAR,
                $toolbar,
                get_string('privacy:themecr_organizacionalsettings_enableaccessibilitytoolbar', 'theme_cr_organizacional', $toolbar)
            );
            ...
            if (isset($fontsize)) {
                writer::export_user_preference(
                    ...
                    self::FONTSIZE,
                    $fontsize,
                    get_string('privacy:accessibilitystyles_fontsizeclass', 'theme_cr_organizacional', $fontsize)
                );
            }
            ...
            if (isset($sitecolor)) {
                writer::export_user_preference(
                    ...
                    self::SITECOLOR,
                    $sitecolor,
                    get_string('privacy:accessibilitystyles_sitecolorclass', 'theme_cr_organizacional', $sitecolor)
                );
            }
        }
        ...
        if (isset($fonttype)) {
            writer::export_user_preference(
                ...
                self::FONTTYPE,
                $fonttype,
                get_string('privacy:themecr_organizacionalsettings_fonttype', 'theme_cr_organizacional', $fonttype)
            );
        }
    }
}
