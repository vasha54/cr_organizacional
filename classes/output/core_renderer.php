...
namespace theme_cr_organizacional\output;

use theme_config;
use core\context\course as context_course;
use moodle_url;
use html_writer;
use theme_cr_organizacional\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themecr_organizacionalsettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themecr_organizacionalsettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('cr_organizacional_additional_header', 'lib.php');
    ...
    public function get_module_footer_callbacks_data() {
        $callbacks = get_plugins_with_function('cr_organizacional_module_footer', 'lib.php');
