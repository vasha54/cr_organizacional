...
namespace theme_cr_organizacional\output\core;

use html_writer;
use coursecat_helper;
use stdClass;
use core_course_list_element;
use theme_cr_organizacional\util\course;

/**
 * Renderers to align cr_organizacional's course elements to what is expect
 *
 * @package    theme_cr_organizacional
 * @copyright  2022 Willian Mano {@link https://conecti.me}
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
...
class course_renderer extends \core_course_renderer {
    ...
    protected function coursecat_coursebox_content(coursecat_helper $chelper, $course) {
        ...
        return $this->render_from_template('theme_cr_organizacional/cr_organizacional_coursecard', $data);
    }
