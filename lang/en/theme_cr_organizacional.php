...
$string['pluginname'] = 'CR-Organizacional';
$string['configtitle'] = 'CR-Organizacional';
$string['choosereadme'] = 'CR-Organizacional is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['privacy:metadata:preference:themecr_organizacionalsettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themecr_organizacionalsettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themecr_organizacionalsettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themecr_organizacionalsettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';
