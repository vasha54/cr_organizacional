...
$THEME->name = 'cr_organizacional';
$THEME->sheets = [];
$THEME->editor_sheets = [];
$THEME->editor_scss = ['editor'];
$THEME->usefallback = false;
$THEME->scss = function($theme) {
    return theme_cr_organizacional_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_cr_organizacional_get_extra_scss';
$THEME->prescsscallback = 'theme_cr_organizacional_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_cr_organizacional_get_precompiled_css';
$THEME->yuicssmodules = [];
